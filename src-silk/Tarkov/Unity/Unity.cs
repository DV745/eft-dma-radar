...
namespace eft_dma_radar.Silk.Tarkov.Unity
{
    ...
    {
        // ── GameObject ──────────────────────────────────────────────────────
        public const uint GO_ObjectClass   = 0x48;  // GameObject → ObjectClass (m_Object)
        ...
        public const uint GomFallback        = 0x1A46AF0;  // UnityPlayer.dll Dec 2025
        public const uint AllCameras         = 0x19EACC0;  // AllCameras static (Dec 2025)
        ...
        public static class Camera
        {
            ...
            public static uint ViewMatrix = 0x118;
